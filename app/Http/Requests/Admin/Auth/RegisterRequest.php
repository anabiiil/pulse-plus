 ...
 * Register Request
 *
 * Handles validation for admin registration.
 */
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'auth_type' => 'required|string|in:basic',
            'email' => 'required_without:phone|string|email|max:255|unique:admins,email',
            'phone' => 'nullable|required_without:email|string|max:20|unique:admins,phone',
            'password' => 'required_if:auth_type,basic|string|min:8|confirmed',
            'provider' => 'required_if:auth_type,social|string|max:255',
            'provider_id' => 'required_if:auth_type,social|string|max:255',
            'otp' => 'required_if:auth_type,otp|string|max:10',
        ];
    }

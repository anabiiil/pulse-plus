...
class CreateProductRequest extends FormRequest
{
    ...
    {
        return [
            'name.en.required' => 'The product name (English) is required.',
            'name.en.string' => 'The product name (English) must be a string.',
            'name.en.max' => 'The product name (English) must not exceed 100 characters.',
            'name.ar.required' => 'The product name (Arabic) is required.',
            'name.ar.string' => 'The product name (Arabic) must be a string.',
            'name.ar.max' => 'The product name (Arabic) must not exceed 100 characters.',

...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'payment_method_name' => $this->resolvePaymentName(),
    ...
    /**
     * Resolve the payment method name snapshot in English for the admin dashboard.
     */
    private function resolvePaymentName(): ?string
    {

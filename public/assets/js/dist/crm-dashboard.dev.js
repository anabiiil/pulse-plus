...
var crm_main = document.querySelector("#crm-main");
...
var crm_total_customers = document.querySelector("#crm-total-customers");

if (crm_total_customers) {
  crm_total_customers.innerHTML = "";
}
...
var crm_total_revenue = document.getElementById('crm-total-revenue');

if (crm_total_revenue) {
  crm_total_revenue.innerHTML = '';
}
...
var crm_conversion_ratio = document.getElementById('crm-conversion-ratio');

if (crm_conversion_ratio) {
  crm_conversion_ratio.innerHTML = '';
}
...
var crm_total_deals = document.getElementById('crm-total-deals');

if (crm_total_deals) {
  crm_total_deals.innerHTML = '';
}
...
var crm_revenue_analytics = document.querySelector("#crm-revenue-analytics");

if (crm_revenue_analytics) {
  crm_revenue_analytics.innerHTML = '';
}
...
var crm_profits_earned = document.querySelector("#crm-profits-earned");

if (crm_profits_earned) {
  crm_profits_earned.innerHTML = '';
}
...
function leads(myVarVal) {
  chartInstance.data.datasets[0] = {
    label: 'My First Dataset',
    data: [32, 27, 25, 16],
    backgroundColor: ["rgb(".concat(myVarVal, ")"), 'rgb(35, 183, 229)', 'rgb(245, 184, 73)', 'rgb(38, 191, 148)']
  };

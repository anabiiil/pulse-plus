<template>
    <div class="col-xl-12">
        <div class="text-end my-4">
            <router-link to="/dash/services/create" class="btn btn-info me-2 btn-b">
                Create Service
            </router-link>
        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                >
                                    ...
                                    <template #item.name="{ item }">
                                        <router-link :to="`/dash/services/${item.id}/update`" class="text-primary">
                                            {{ item.name?.en }}
                                        </router-link>
                                    </template>

                                    <template #item.image_url="{ item }">
                                        <img v-if="item.image_url" :src="item.image_url" alt="service image" style="height: 50px; width: auto;">
                                    ...
                                    <template #item.actions="{ item }">
                                        <v-menu>
                                            ...
                                            <v-list>
                                                ...
                                                <v-list-item>
                                                    <v-list-item-title>
                                                        <router-link :to="{ path: `/dash/services/${item.id}/delete` }" class="text-danger">

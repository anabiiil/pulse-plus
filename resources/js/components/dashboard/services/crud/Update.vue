        ...
        <div class="card custom-card">
            <div class="card-header">
                <div class="card-title text-capitalize">
                    Update Service ({{ formData?.name?.en }})
                </div>
            </div>
            <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <img v-else-if="service?.image_url" :src="service.image_url" alt="current" style="height: 100px; margin-top: 10px;">
                                    </div>
                                </div>
...
const { update, getService: fetchService, service } = useServices();
...
const loadService = async () => {
    try {
        ...
        if (service.value) {
            formData.name.en = service.value.name?.en || '';
            formData.name.ar = service.value.name?.ar || '';
...
const handleSubmit = async () => {
    ...
    try {
        ...
        await update(serviceId.value, data);
        await router.push('/dash/services');
    } catch (error: any) {

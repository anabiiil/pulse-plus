<template>
    ...
    <div class="col-xl-12">
        <div class="text-end my-4">
            <router-link to="/dash/slider/create" class="btn btn-info me-2 btn-b">
                Create Slider
            </router-link>
        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                >
                                    ...
                                    <template #item.image="{ item }">
                                                <span class="d-inline-block overflow-hidden" style="width:30px;height:30px;">
                                            <img :src="item.image" alt="image" style="width: 100%;height: 100%;object-fit: cover;">
                                        </span>
                                    </template>
                                    ...
                                    <template #item.actions="{ item }">
                                        ...
                                        <v-menu>
                                            ...
                                            <v-list>
                                                <v-list-item>
                                                    <v-list-item-title>
                                                        <router-link :to="`/dash/slider/${item.id}/update`"
                                                                     class="text-primary">
                                                ...
                                                <v-list-item>
                                                    <v-list-item-title>
                                                        ...
                                                        <router-link
                                                            :to="{ path: `/dash/slider/${item.id}/delete`}"
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            {key: 'image', title: 'Image', sortable: false},

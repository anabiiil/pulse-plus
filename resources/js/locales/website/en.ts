export default {
  ...
  profile: {
    ...
    form: {
      ...
      displayEmergency: 'Display Emergency Call Button',
      displayEmergencyDesc: 'Allow others to call your emergency contact from your profile page',
      emergencyProfileLink: 'Your Emergency Profile Link',
      emergencyProfileLinkDesc: 'Share this link to display your medical information in emergencies',

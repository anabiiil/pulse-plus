                ...
                <div class="header-element headerProfile-dropdown">
                    ...
                    <a href="javascript:void(0);" class="header-link dropdown-toggle " id="mainHeaderProfile"
                       data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                        <span class="bg-primary text-center overflow-hidden"
                              style="height: 35px;width:35px;line-height: 35px;border-radius: 50%">
                            {{ Str::upper(Str::limit(auth('admin')->user()?->name, 1, '')) }}
                        </span>
                    </a>
                    <!-- End::header-link|dropdown-toggle -->
                    <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                        ...
                        <li>
                            <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                                <div class="my-auto">
                                    <h6 class="mb-0 lh-1 text-fixed-white">{{ auth('admin')->user()?->name }}</h6><span
                        ...
                        {{--                                <i class="bx bx-log-out fs-18 me-2 op-7"></i>Profile--}}
                        {{--                            </a>--}}
                        {{--                        </li>       --}}
                        ...
                        <li>
                            <form method="POST" action="{{ route('admin.logout') }}">
                                @csrf
                                <button class="dropdown-item d-flex"><i class="bx bx-log-out fs-18 me-2 op-7"></i>Logout
                                </button>
                            </form>
                        </li>
...
{{--                <div class="my-auto">--}}
{{--                    <h5 class="page-title fs-21 mb-1">Index</h5>--}}
{{--                    <nav>--}}
{{--                        <ol class="breadcrumb mb-0">--}}
{{--                            <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Index</a></li>--}}

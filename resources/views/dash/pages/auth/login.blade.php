        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                ...
                <div class="sidemenu-layout-styles">
                    ...
                    <div class="px-4 pb-3 text-secondary fs-11"><span
                            class="fw-semibold fs-12 text-dark me-2 d-inline-block">Note:</span>Navigation menu styles
                        won't work here.
                    </div>
                </div>
            </div>
...
<div class="container-fluid custom-page">
    <div class="row bg-white">
        ...
        {{--                    <img src="{{ asset('dash/assets') }}/images/media/pngs/5.png"--}}
        {{--                         class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">--}}
        {{--                </div>--}}
        {{--            </div>--}}
        {{--        </div>--}}
        <!-- The content half -->
        <div class="col-md-4 col-lg-4  bg-white py-4"></div>
        <div class="col-md-4 col-lg-4  bg-white py-4">
...
<!-- Show Password JS -->
@livewireScripts
<script src="{{ asset('dash/assets') }}/js/show-password.js"></script>
<script src="{{ asset('dash/assets/custom/js/custom.js') }}"></script>
<script>
    ...
    //
    //     axios.post('/test-api', formData)
    //         .then(response => {
    //             showToast('success')
    //             ;
    //         })
    //         .catch(error => {
    //             showToast('catch error success','error')
    //
    //             console.error(error);
    //         });
    // });

<div>
    <div class="modal fade" id="update_club" wire:ignore.self data-bs-keyboard="false" tabindex="-1" aria-labelledby="updateClubLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="updateClubLabel"> Update Club</h6>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                                ...
                                <input type="text" wire:model.defer="official_name" name="official_name" class="form-control  @error('official_name') is-invalid @enderror" placeholder="Enter Official Name">
                                @error('official_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                                ...
                                <input type="text" wire:model.defer="code" name="code" class="form-control  @error('code') is-invalid @enderror" placeholder="Enter Code">
                                @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-2">
                                ...
                                <input type="file" wire:model.defer="image" name="image" class="form-control  @error('image') is-invalid @enderror">
                                @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-2">
                                ...
                                <input type="file" wire:model.defer="t_shirt_image" name="t_shirt_image" class="form-control  @error('t_shirt_image') is-invalid @enderror">
                                @error('t_shirt_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-2">
                                ...
                                <select wire:model="country_id" class="form-select form-control @error('country_id') is-invalid @enderror">
                                    <option>Select Country</option>
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}" @selected($country->id == $club->country_id)>{{ $country->name }}</option>
                                    @endforeach
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-2">
                                ...
                                <select wire:model="coach_id" class="form-select form-control @error('coach_id') is-invalid @enderror">
                                    <option>Select Coach</option>

                                    @foreach ($coaches as $coach)
                                        <option value="{{ $coach->id }}" @selected($coach->id == $club?->coach_id)>{{ $coach->full_name }}</option>
                                    @endforeach

<div>
    ...
    <div wire:ignore.self class="modal fade" id="activate_competition" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <div style="margin-bottom: 1rem;">
                        ...
                        <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <!--begin::Content-->
                                @if($compatition)
                                    <span>Are You Sure Activate {{ $compatition->name }}</span>
                                @endif
                                <!--end::Content-->
                            </div>
                            <!--end::Wrapper-->
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-success me-10" wire:click="store">
                            ...
                            <span class="d-none" wire:loading.class.remove="d-none" wire:target="store">

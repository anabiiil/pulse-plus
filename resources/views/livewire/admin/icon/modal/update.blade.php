<div>
    <div class="modal fade" id="update_icon" wire:ignore.self data-bs-keyboard="false" tabindex="-1"
         aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="staticBackdropLabel"> Update Icon</h6>
                                ...
                                <div class="form-group">
                                    ...
                                    <select wire:model="icon_category_id"
                                        ...
                                        @foreach ($icon_categories as $icon_category)
                                            <option value="{{ $icon_category->id }}"
                                            @selected($icon_category->id == $icon_category_id)>{{ $icon_category->name }}</option>
                                        @endforeach

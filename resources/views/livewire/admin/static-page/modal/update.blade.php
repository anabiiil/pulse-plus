<div>
    <div class="modal fade" id="update_static_page" wire:ignore.self data-bs-keyboard="false" tabindex="-1"
         aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="staticBackdropLabel"> Update Static Page</h6>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                                ...
                                <input type="text" wire:model.defer="name.en" name="name.en" disabled
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">
                                ...
                                <input type="text" wire:model.defer="name.ar" name="name.ar" disabled
                                       class="form-control  @error('name') is-invalid @enderror
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 mb-2">
                                ...
                                <select wire:model="type" class="form-control" disabled>
                                    ...
                                    @foreach ($types as $key => $type)
                                        <option value="{{ $key }}" @selected($type == $type)>{{ $key }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('type')
                        ...
                        <div class="row">
                            ...
                            {{--                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-2">--}}
                            {{--                                <label for="input-text" class="form-label">Type</label>--}}
